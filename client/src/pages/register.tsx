...
import { ArrowRight, CheckCircle2, Mail, Eye, Sparkles } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (authStep === "email") {
        ...
        toast({ title: "Welcome to Product Academy!", description: "Your account has been created." });
        setLocation("/");
      }
    } catch (error) {
      toast({ 
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="bg-primary/5 rounded-2xl p-4 mb-6 border border-primary/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-foreground mb-1">Free access included</p>
                <p className="text-xs text-muted-foreground">
                  Get instant access to free courses, AI coaching, and community features.
                </p>
              </div>
            </div>
          </div>
